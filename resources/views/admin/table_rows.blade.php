@forelse ($kategoris as $key => $item)
    <tr class="text-center align-middle">
        ...
        <td>
            ...
            {{-- halaman edit --}}
            <x-modal name="edit-kategori-{{ $item->id_kategori }}" focusable>
                <form
                    method="post"
            ...
            {{-- halaman hapus --}}
            <x-modal name="konfirmasi-hapus-{{ $item->id_kategori }}" focusable>
                <div class="p-6">
                    <div
                    ...
                    >
                        ...
                        <div>
                            <h2 class="text-lg font-medium text-gray-900 m-0">
                                Hapus Kategori?
                            </h2>
                    ...
                    <div class="mt-4 bg-light p-3 rounded border text-start">
                        ...
                        @if ($item->buku_count > 0)
                            ...
                            >
                                ...
                                Perhatian: Ada
                                <strong>{{ $item->buku_count }} buku</strong>
