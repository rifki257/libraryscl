                        ...
                        <form action="{{ route('buku.update', $buku->id_buku) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        @if($buku->gambar)
                                        <img src="{{ asset('storage/' . $buku->gambar) }}" alt="cover" class="rounded shadow-sm mb-2 mx-auto" style="width: 150px; height: auto;">
                                    @else
                                        <p class="text-muted italic">Tidak ada gambar sebelumnya</p>
                                    @endif
                                    <input type="file" name="gambar" class="form-control">
                                    <small class="text-secondary text-sm italic">*Biarkan kosong jika tidak ingin mengganti gambar</small>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="jumlah" class="form-control" value="{{ old('jumlah', $buku->jumlah) }}" required>
                                    </div>
                                </div>
                            </div>
